...
void ClientKnobs::initialize(Randomize randomize, IsSimulated isSimulated) {
	...
	init( INIT_MID_SHARD_BYTES,               10000000 ); if( randomize && buggify() ) INIT_MID_SHARD_BYTES = 40000; else if(randomize && buggify(0.75)) INIT_MID_SHARD_BYTES = 200000; // The same value as SERVER_KNOBS->MIN_SHARD_BYTES
